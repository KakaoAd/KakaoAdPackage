...
/// @param bradn 브랜드
/// @return KakaoAdDetailProduct instance
- (nonnull instancetype)initWithId:(NSString * _Nullable)id name:(NSString * _Nullable)name quantity:(NSInteger)quantity price:(double)price brand:(NSString * _Nullable)brand OBJC_DESIGNATED_INITIALIZER;
