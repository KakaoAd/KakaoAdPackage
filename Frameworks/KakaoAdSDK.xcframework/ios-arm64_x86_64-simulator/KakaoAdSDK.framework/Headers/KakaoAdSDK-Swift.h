...
/// @param price 상품가격
/// @param bradn 브랜드
/// @param brandId 브랜드아이디
/// @return KakaoAdDetailProduct instance
- (nonnull instancetype)initWithId:(NSString * _Nullable)id name:(NSString * _Nullable)name quantity:(NSInteger)quantity price:(double)price brand:(NSString * _Nullable)brand brandId:(NSString * _Nullable)brandId OBJC_DESIGNATED_INITIALIZER;
...
/// @deprecated 이 함수는 더 이상 사용되지 않습니다. 대신 sendViewContentEvent(tag:products:)를 사용하세요.
+ (void)sendViewContentEventWithTag:(NSString * _Nullable)tag contentId:(NSString * _Nullable)contentId SWIFT_DEPRECATED_MSG("이 함수는 더 이상 사용되지 않습니다. 대신 sendViewContentEvent(tag:products:)를 사용하세요.");
/// 콘텐츠/상품 조회 이벤트
/// @param tag tag 의 경우, 한 광고계정 내에서 같은 이벤트코드 내에서도 특별한 분류가 필요할 때 추가합니다.
/// @param currency 결제 금액 통화 (ISO4217 포맷)
/// @param products KakaoAdDetailProduct 클래스 객체의 Array 타입을 입력 받습니다. 개별 상품 상세 정보의 리스트 입니다.
+ (void)sendViewContentEventWithTag:(NSString * _Nullable)tag currency:(NSString * _Nullable)currency products:(NSArray<KakaoAdDetailProduct *> * _Nonnull)products;
/// Search Event
/// @param tag tag
...
/// @param currency 결제 금액 통화 (ISO4217 포맷)
/// @param transactionId 주문번호와 같이, 구매에 대한 유니크한 단위 ID
/// @param products KakaoAdDetailProduct 클래스 객체의 Array 타입을 입력 받습니다. 개별 주문 상품 상세 정보의 리스트 입니다.
+ (void)sendPurchaseEventWithTag:(NSString * _Nullable)tag totalQuantity:(NSInteger)totalQuantity totalPrice:(double)totalPrice currency:(NSString * _Nullable)currency transactionId:(NSString * _Nullable)transactionId products:(NSArray<KakaoAdDetailProduct *> * _Nonnull)products;
/// 목표달성
/// @param tag tag 의 경우, 한 광고계정 내에서 같은 이벤트코드 내에서도 특별한 분류가 필요할 때 추가합니다.
...
/// @param tag tag 의 경우, 한 광고계정 내에서 같은 이벤트코드 내에서도 특별한 분류가 필요할 때 추가합니다.
/// @param contentId 콘텐츠/상품 코드
/// @deprecated 이 함수는 더 이상 사용되지 않습니다. 대신 sendAddToCartEvent(tag:products:)를 사용하세요.
+ (void)sendAddToCartEventWithTag:(NSString * _Nullable)tag contentId:(NSString * _Nullable)contentId SWIFT_DEPRECATED_MSG("이 함수는 더 이상 사용되지 않습니다. 대신 sendAddToCartEvent(tag:products:)를 사용하세요.");
/// 장바구니 추가 이벤트
/// @param tag tag 의 경우, 한 광고계정 내에서 같은 이벤트코드 내에서도 특별한 분류가 필요할 때 추가합니다.
/// @param currency 결제 금액 통화 (ISO4217 포맷)
/// @param products KakaoAdDetailProduct 클래스 객체의 Array 타입을 입력 받습니다. 개별 상품 상세 정보의 리스트 입니다.
+ (void)sendAddToCartEventWithTag:(NSString * _Nullable)tag currency:(NSString * _Nullable)currency products:(NSArray<KakaoAdDetailProduct *> * _Nonnull)products;
/// 관심상품 추가 이벤트
/// @param tag tag 의 경우, 한 광고계정 내에서 같은 이벤트코드 내에서도 특별한 분류가 필요할 때 추가합니다.
/// @param contentId 콘텐츠/상품 코드
/// @deprecated 이 함수는 더 이상 사용되지 않습니다. 대신 sendAddToWishListEvent(tag:products:)를 사용하세요.
+ (void)sendAddToWishListEventWithTag:(NSString * _Nullable)tag contentId:(NSString * _Nullable)contentId SWIFT_DEPRECATED_MSG("이 함수는 더 이상 사용되지 않습니다. 대신 sendAddToWishListEvent(tag:products:)를 사용하세요.");
/// 관심상품 추가 이벤트
/// @param tag tag 의 경우, 한 광고계정 내에서 같은 이벤트코드 내에서도 특별한 분류가 필요할 때 추가합니다.
/// @param currency 결제 금액 통화 (ISO4217 포맷)
/// @param products KakaoAdDetailProduct 클래스 객체의 Array 타입을 입력 받습니다. 개별 상품 상세 정보의 리스트 입니다.
+ (void)sendAddToWishListEventWithTag:(NSString * _Nullable)tag currency:(NSString * _Nullable)currency products:(NSArray<KakaoAdDetailProduct *> * _Nonnull)products;
